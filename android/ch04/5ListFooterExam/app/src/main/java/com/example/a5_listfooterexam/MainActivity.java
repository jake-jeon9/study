...
import com.example.a5_listfooterexam.model.JobAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = footerView.findViewById(R.id.footerButton);

        //listView에 footer추가 : 반드시 adapter 설정 전에 추가해야 함.
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String reuslt = "직업 명 : " + item.getTitle() + "\n설명 : " + item.getDescription();

        Toast.makeText(this, reuslt, Toast.LENGTH_SHORT).show();
