...
public class MainActivity extends AppCompatActivity implements MainFragment.OnListItemSelectedListener {
   ...
   //     adapter = new JobAdapter(this,R.layout.list_item,list);
      ...
      //  subFragment = new SubFragment(R.id.container,mainFragment);
    ...
    //        Job item = adapter.getItem(position);
      ...
      //  subFragment.updata(item);
        subFragment.updata(job);
        subFragment.getActivity(mainFragment);
    }
