...
class Event1 extends JFrame implements ActionListener{
	...
	ImageIcon index1 = new ImageIcon("img/index1.png");
...
//	ImageIcon icon1 = new ImageIcon("img/icon1.png"); //글쓰기
//	ImageIcon icon2 = new ImageIcon("img/icon2.png"); //삭제
	ImageIcon icon3 = new ImageIcon("img/icon3.png"); //갱신
	
	JLabel label1 = new JLabel(watermark);
	JLabel label2 = new JLabel(index1, JLabel.LEFT);
...
public class CallListOftourist {
