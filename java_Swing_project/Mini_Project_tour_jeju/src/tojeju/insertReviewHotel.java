...
class Review3 extends JFrame implements ActionListener, MouseListener {
	
	ImageIcon review3 = new ImageIcon("img/review3.png");
	...
	JLabel buttonRT = new JLabel(review3);
...
public class insertReviewHotel {
