...
class Review2 extends JFrame implements ActionListener, MouseListener {
	
	ImageIcon review2 = new ImageIcon("img/review2.png");
	...
	JLabel buttonRT = new JLabel(review2);
	...
	String getPhotoroot;
	int k = 0;
	ImageIcon img1 = new ImageIcon(getPhotoroot);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == buttonSave) {
			...
			if (k == 0) {
				...
				String subjct = "선택한 파일명 : "
						+ getPhotoroot.substring(getPhotoroot.lastIndexOf("img") + 4, getPhotoroot.indexOf("."));
				System.out.println(subject);
				new DialogPhoto(subjct, getPhotoroot);
...
public class insertReviewRestaurants {
