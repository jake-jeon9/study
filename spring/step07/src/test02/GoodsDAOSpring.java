...
public class GoodsDAOSpring {
	...
	// sql명령문
		...
		int insertGoods(GoodsVO vo) {
			...
			//괄호 안 순서 , 1 sql문, 2 물음표에 들어가는 데이터 값들.
		...
		GoodsVO getGoods(GoodsVO vo) {
			...
			return jdbcTemplate.queryForObject(sql_get, args,new GoodsRowMapper());
			// 1. sql문  / 2.  ? 에들어갈 데이터-배열 / 리턴값의 자료형.  즉, goodsMapper 의자료형( goodsVO) 또는 스트링,인트 등 
